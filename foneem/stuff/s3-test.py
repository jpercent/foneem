...
import httplib
import sys
AWS_ACCESS_KEY_ID = 'AKIAJOTPDESARS356A6Q'
AWS_SECRET_ACCESS_KEY = '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'
...
BUCKET_NAME = "%s-human-voice-bank" % AWS_ACCESS_KEY_ID.lower();

  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<h1><strong>Create An Account</strong></h1>
      <p class="mad-libs">
        ...
        <label>
          <select name="gender" class="dropdown">
          	<option value="" class="default" disabled selected>Gender</option>
        ...
        <label>
          <input type="text" name="stateprovince" value="" placeholder="Province/State" />
        </label>,
        <label>
      ...
      My e-mail address is
        ...
        .
      	<label>
          <input name="password" class="password" type="password" placeholder="Password" this_placeholder="Password">
        </label>
        <label>
          <input name="password_confirm" class="password_confirm" type="password" placeholder="Confirm Password" this_placeholder="Confirm Password">
        </label>
      </p>
      <div class="row agreement">
      	<div class="col-md-6 agreement-links"><input type="checkbox" class="custom-checkbox">&nbsp;</button>I have read and agree to The Human Voicebank Initiative <a target="_blank" href="./terms/">Terms of Use</a> & <a target="_blank" href="./privacy/">Privacy Policy</a>.</div>
      	<div class="col-md-6 agreement-button"><input type="submit" value="Sign Up" class="btn btn-record mad-libs-submit"></input></div>
      </div>
    </form>
	</section>
